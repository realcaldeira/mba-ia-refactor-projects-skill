"""Orquestra os casos de uso de produto. Sem SQL e sem regra de negócio."""
import logging
...
class ProdutoController:
    ...
    def listar(self):
        dados = self._produtos.listar(
            pagina=request.args.get("pagina"), tamanho=request.args.get("tamanho")
        )
    ...
    def pesquisar(self):
        ...
        resultados = self._produtos.buscar(
