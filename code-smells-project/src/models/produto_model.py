"""Produto: acesso a dados e regras da entidade."""
...
def validar(dados):
    """Regra de negócio do produto — a mesma para criação e atualização."""
    if not dados:
...
class ProdutoModel(BaseModel):
    ...
    def buscar(self, termo=None, categoria=None, preco_min=None, preco_max=None):
        """Filtro dinâmico: a estrutura é montada aqui, os valores vão como parâmetro."""
