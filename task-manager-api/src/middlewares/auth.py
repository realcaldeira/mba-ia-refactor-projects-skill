"""Autenticação por token assinado — substitui o 'fake-jwt-token-<id>'.

A infraestrutura existe e é usada pelo login; tornar uma rota protegida é envolver a view
com `requer_autenticacao`.
"""
import hashlib
import hmac
import json
