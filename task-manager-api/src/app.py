...
def create_app(config=settings, database_uri=None, notificador=None):
    ...
    app.register_blueprint(task_routes.criar_blueprint(tasks, config))
    app.register_blueprint(user_routes.criar_blueprint(usuarios, config))
    app.register_blueprint(report_routes.criar_blueprint(relatorios, categorias, config))
