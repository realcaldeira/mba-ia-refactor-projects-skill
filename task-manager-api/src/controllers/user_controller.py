...
from src.utils.constants import PAPEL_USUARIO
...
class UserController:
    ...
    def criar(self):
        ...
        papel = validators.validar_papel(dados.get("role", PAPEL_USUARIO))
    ...
    def atualizar(self, user_id):
        ...
        if "role" in dados:
            usuario.role = validators.validar_papel(dados["role"])
        if "active" in dados:
    ...
    def remover(self, user_id):
        ...
        # O cascade do relacionamento remove as tasks na mesma transação.
        ...
        return jsonify(
            {
                ...
                "token": gerar_token(usuario, self._segredo, self._ttl),
            }
        ), 200
