...
class CategoryController:
    ...
    def listar(self):
        ...
        return (jsonify([c.to_dict(task_count=contagens.get(c.id, 0)) for c in Category.listar()]), 200)
    ...
    def criar(self):
        ...
        categoria = Category(name=nome, description=dados.get('description', ''), color=dados.get('color', COR_PADRAO))
